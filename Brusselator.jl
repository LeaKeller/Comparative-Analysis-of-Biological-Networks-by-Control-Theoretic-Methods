...
function Brusselator_default()
    ...
    constants = [:k1 => 1.28, :k2 => 2.4*10^6, :k3 => 33.6, :k4 => 2400, :A => 0.06, :B => 0.02, :D => 1, :E => 1] # kinetic constants, constant concentrations (values to be adapted for optimal metabolism)
    tspan = (0.0, 10.0) # 100
